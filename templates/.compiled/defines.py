...
def newtag_cp_filtertags(inp, ginp, innerHTML): 
  ...
  outpvar.open(htmlnode("form", extentattrs(cod([("data", cod([("onsubmit", "sreq"), ("bobj", ""), ("params", "ms.searchparam();"), ("action", "search"), ("res", "ms.f1(data);")]))]))));
  ...
  outpvar.close();
  outpvar.close();
  outpvar.open(htmlnode("div", extentattrs(cod([("style", cod([("max-height", "400px"), ("overflow-y", "auto")]))]))));
  ...
  for i in forlist(inp["catgtree"], False ) :
    outpvar.open(htmlnode("li", extentattrs(cod([]))));
    outpvar.open(htmlnode("div", extentattrs(cod([("class", "collapsible-header")]))));
    outpvar.cur.addfcdata("icon1");
    outpvar.addchilds(newtag_icon1(cod([("img", inp["icons"][i])]), ginp, outpvar.cur.fcalldata["icon1"].root.content).root.content);
    outpvar.addtext(inp["dictl"]["tabs"][i]["tabs"]);
    outpvar.close();
    ...
    for j in forlist(inp["catgtree"][i], False ) :
      ...
      outpvar.addtext(inp["dictl"]["cat"][j]["cat"]);
      outpvar.close();
      outpvar.open(htmlnode("div", extentattrs(cod([("class", "collapsible-body")]))));
      ...
      outpvar.addchilds(newtag_checkbox1(cod([("label", "Select All"), ("id", myadd(myadd(myadd(myadd(myadd(myadd("catsubcat", i), "_"), j), "_"), "selectall"), inp["typ"])), ("aclass", "selectall"), ("data", cod([("onclick", "selectall redraw"), ("catgtid", myadd(myadd(i, "_"), j))])), ("labels", cod([("font-size", "12px")]))]), ginp, outpvar.cur.fcalldata["checkbox1"].root.content).root.content);
      outpvar.close();
      outpvar.close();
      for k in forlist(inp["catgtree"][i][j], False ) :
        outpvar.open(htmlnode("li", extentattrs(cod([]))));
        outpvar.open(htmlnode("div", extentattrs(cod([]))));
        outpvar.cur.addfcdata("checkbox1");
        outpvar.addchilds(newtag_checkbox1(cod([("label", inp["dictl"]["subcat"][k]["subcat"]), ("id", myadd(myadd(myadd(myadd(myadd(myadd("catsubcat", i), "_"), j), "_"), k), inp["typ"])), ("data", cod([("catgtid", myadd(myadd(myadd(myadd(i, "_"), j), "_"), k)), ("onclick", "redraw")])), ("labels", cod([("font-size", "12px")]))]), ginp, outpvar.cur.fcalldata["checkbox1"].root.content).root.content);
        outpvar.close();
        outpvar.close();
      outpvar.close();
      outpvar.close();
...
def newtag_businesscard(inp, ginp, innerHTML): 
  inp = overwriteattrs(extentattrs(cod([])), extentattrs(inp));
  mifu(inp, ginp);
  outpvar = htmltree();
  outpvar.open(htmlnode("div", extentattrs(cod([("attr", cod([("id", "providerinfo")])), ("class", "modal bottom-sheet")]))));
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "container-fluid")]))));
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "row")]))));
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "col l4 m12 s12")]))));
  outpvar.open(htmlnode("h5", extentattrs(cod([]))));
  outpvar.cur.addfcdata("a1");
  outpvar.addchilds(newtag_a1(cod([("class", "truncate info_name"), ("attr", cod([("target", "_blank")])), ("text", "New Age Pet")]), ginp, outpvar.cur.fcalldata["a1"].root.content).root.content);
  outpvar.close();
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "grey-text text-darken-2 p5")]))));
  outpvar.cur.addfcdata("icon");
  outpvar.addchilds(newtag_icon(cod([("name", "navigation"), ("aclass", "tiny")]), ginp, outpvar.cur.fcalldata["icon"].root.content).root.content);
  outpvar.open(htmlnode("span", extentattrs(cod([("class", "info_address")]))));
  outpvar.addtext("C-15, Aravali hostel, IITD");
  outpvar.close();
  outpvar.close();
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "grey-text text-darken-2 p5")]))));
  outpvar.cur.addfcdata("icon");
  outpvar.addchilds(newtag_icon(cod([("name", "navigation"), ("aclass", "tiny")]), ginp, outpvar.cur.fcalldata["icon"].root.content).root.content);
  outpvar.open(htmlnode("span", extentattrs(cod([("class", "info_phone")]))));
  outpvar.addtext("+91 7503759053");
  outpvar.close();
  outpvar.close();
  outpvar.close();
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "col l4 m12 s12")]))));
  outpvar.open(htmlnode("h5", extentattrs(cod([]))));
  outpvar.cur.addfcdata("a1");
  outpvar.addchilds(newtag_a1(cod([("class", "truncate info_website"), ("attr", cod([("target", "_blank")])), ("text", "Classes Offered")]), ginp, outpvar.cur.fcalldata["a1"].root.content).root.content);
  outpvar.close();
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "grey-text text-darken-2 p5")]))));
  outpvar.cur.addfcdata("icon");
  outpvar.addchilds(newtag_icon(cod([("name", "navigation"), ("aclass", "tiny")]), ginp, outpvar.cur.fcalldata["icon"].root.content).root.content);
  ...
  outpvar.close();
  outpvar.close();
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "col l3 m12 s12")]))));
  outpvar.open(htmlnode("br", extentattrs(cod([]))));
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "row")]))));
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "col s2 cursp"), ("attr", cod([("onclick", "bcard.prevp();")]))]))));
  outpvar.cur.addfcdata("icon");
  outpvar.addchilds(newtag_icon(cod([("name", "skip_previous")]), ginp, outpvar.cur.fcalldata["icon"].root.content).root.content);
  outpvar.close();
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "col s7")]))));
  outpvar.open(htmlnode("span", extentattrs(cod([("class", "info_cardnum")]))));
  outpvar.addtext("Showing: 1/9");
  outpvar.close();
  outpvar.close();
  outpvar.open(htmlnode("div", extentattrs(cod([("class", "col s2 cursp"), ("attr", cod([("onclick", "bcard.nextp();")]))]))));
  outpvar.cur.addfcdata("icon");
  outpvar.addchilds(newtag_icon(cod([("name", "skip_next")]), ginp, outpvar.cur.fcalldata["icon"].root.content).root.content);
  outpvar.close();
  outpvar.close();
  outpvar.open(htmlnode("button", extentattrs(cod([("class", "waves-effect waves-light btn")]))));
  outpvar.addtext("Favorute");
  outpvar.close();
  outpvar.close();
  outpvar.close();
  outpvar.close();
