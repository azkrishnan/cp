...
outpvar.cur.fcalldata["main1"].open(htmlnode("p", extentattrs("Upload the excell sheet here [Only *.xlsx]")));
outpvar.cur.fcalldata["main1"].close();
outpvar.cur.fcalldata["main1"].open(htmlnode("p", extentattrs("")));
outpvar.cur.fcalldata["main1"].close();
...
outpvar.cur.fcalldata["main1"].open(htmlnode("p", extentattrs("Submit")));
outpvar.cur.fcalldata["main1"].close();
outpvar.cur.fcalldata["main1"].close();
outpvar.cur.fcalldata["main1"].close();
